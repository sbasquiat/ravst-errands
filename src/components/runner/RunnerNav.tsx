...
import { updateRunnerProfile } from "@/lib/supabase/actions";
...
export default function RunnerNav({ userInitials, initialAvailable, children }: RunnerNavProps) {
  ...
  const handleToggleAvailability = async () => {
    ...
    await updateRunnerProfile({ is_available: newValue });
  };
